...
const makeApp = (products) => {
  ...
  const bestSellerButton = $("<img />")
    .attr("src", "https://cdn.shopify.com/s/files/1/0513/5135/5554/files/button_red_1.png?v=1606312663")
    .css({
      'position': 'fixed',
      'width': '150px',
      'bottom': '20px',
...
fetch(
  `https://cors-anywhere.herokuapp.com/https://368623574688.ngrok.io/api/products`
)
  .then((res) => res.json())
  .then((data) => makeApp(data.data))
